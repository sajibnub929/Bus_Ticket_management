   ...
   <div class="container">
    <div class="form-sections">
      ...
      <div class="Form-left">
        ...
        <p style="color: black;">Contact us for latest news and updates. </p><br>

        <!--first Heading -->
        <h4 style="color: black;">ADDRESS</h4>
         <span style="color: white;">Hazicamp, Ashkona, Dhaka-1230</span>
         <hr><br><br>

         <!--second Heading -->
        <h4 style="color: black;">PHONE</h4>
         <span style="color: white;">+8801783967440</span>
         <hr><br><br>

       <!--third Heading -->
        <h4 style="color: black;">EMAIL</h4>
         <span style="color: white;">asrafuzzamanshojib2002@gmail.com</span>
         <hr> <br>
